import 'package:consumindo_api/src/repositories/moeda_repository.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  test('Converter um xml em uma lista de MoedaMoedel', () {
    final repository = MoedaRepository();
    final moedas = repository.parseMoeda(xml);
    print(moedas);
  });
  ...
  test('Pegar apenas a cotação', () {
    ...
    expect(4.9059, cotacao);
  });
}

const json =
    '''
{"USDBRL":{"code":"USD","codein":"BRL","name":"Dólar Americano/Real Brasileiro","high":"4.9123","low":"4.8509","varBid":"0.0432","pctChange":"0.89","bid":"4.9059","ask":"4.9069","timestamp":"1700256601","create_date":"2023-11-17 18:30:01"}}
''';
